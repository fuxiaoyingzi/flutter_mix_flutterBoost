    ...
    public static boolean openPageByUrl(Context context, String url, Map params, int requestCode) {
        ...
        try {
            if (pageName.containsKey(path)) {
                ...
                return true;
            } else if (url.startsWith(NATIVE_NEW_PAGE_URL)) {
                context.startActivity(new Intent(context, NewNativePageActivity.class));
            } else if (url.startsWith(MAIN_NATIVE_PAGE_URL)) {
                context.startActivity(new Intent(context, MainNativePageActivity.class));
            }
